  ...
  <div>
    ...
    <div class="highlighted">
      ...
      <SfProperty
        ...
        :value="
          $n(
            getShippingMethodPrice(selectedShippingMethod, totals.total),
            'currency'
          )
        "
        class="sf-property--full-width sf-property--large property"
    ...
    <div class="highlighted promo-code">
      ...
      <SfButton
        ...
        @click="() => addCoupon({ couponCode: promoCode })"
        >{{ $t("Apply") }}</SfButton
      >
    ...
    <p class="error-block" v-if="error.applyCoupon">
      <SfAlert message="Invalid Coupon!" type="danger" />
    </p>
    <!-- <div class="error-block" v-if="errorMesg.applyCoupon">
      <SfAlert message="errorMesg.applyCoupon.message" type="danger" />
    </div> -->
    <div class="highlighted">
      <SfCharacteristic
